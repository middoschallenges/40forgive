/* =========================================================================
   40 DAYS TO FORGIVENESS — shared schedule + content

   Full 40-day schedule + content, sourced from the final challenge
   spreadsheet. Loaded before challenges.js (single-day view) and
   challenges-index.js (master list view) — both read from window.ChallengesData.
...
(function () {
  ...
  //        task     — array of paragraph strings ("your challenge for today")
  ...
  window.ChallengesData = {
    SCHEDULE: SCHEDULE,
    CONTENT: CONTENT,
    RAFFLE_BASE: RAFFLE_BASE,
    easternToday: easternToday,
    pad2: pad2,
